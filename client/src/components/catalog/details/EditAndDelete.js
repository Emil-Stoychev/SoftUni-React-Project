...
export const EditAndDelete = ({ onDeleteClickHandler, product, changeStatusHandler }) => {
    ...
    return (
        <>
            ...
            <button type="button" className="btn btn-primary" style={{ margin: "0 1% 0 0" }} onClick={changeStatusHandler}> Status: {product.visible ? 'Visible' : 'Private'} </button>
        </>
    )
}